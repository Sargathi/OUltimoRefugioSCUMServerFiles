...
//    Equipamento tático (sem aljava/mochila) + arco recurvo, taco, MRE.
//
...
namespace SpawnSystem
{
    ...
    public class CustomRespawnPlugin : OxygenPlugin
    {
        ...
        public override void OnLoad()
        {
            ...
            // VIP Ouro não inclui aljava/mochila de costas; remove entradas legadas do JSON.
            if (_cfg.VipOuroSet?.Equipment != null)
            {
                _cfg.VipOuroSet.Equipment.RemoveAll(id =>
                    string.Equals(id?.Trim(), "Improvised_Quiver_02_Rags", StringComparison.OrdinalIgnoreCase));
            }
        ...
        {
            // Evita `async void` no hook: exceções não observadas podem derrubar o runtime do Oxygen.
